...
export default function WorkspacePreview() {
  return (
    <section id="demo" className="bg-[#FFF8F1] px-6 py-16 lg:px-8">
      <SectionHeader
        eyebrow="Workspace"
        title="A calm place to start asking"
      ...
      <div className="mx-auto grid max-w-6xl gap-5 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="pastel-card p-6">
          <div className="rounded-3xl border border-dashed border-[#D9B8A8] bg-[#FFF8F1] p-6 text-center">
            ...
            <p className="mt-2 text-sm leading-6 text-[#7A6F6A]">CSV, Excel, or JSON. InsightCanvas reads the columns, flags sensitive fields, and suggests a few useful questions.</p>
          </div>
        ...
        <div className="pastel-card p-6">
          ...
          <div className="mt-5 h-56 rounded-3xl border border-[#EBDDD3] bg-[#FFF8F1] p-5">
            <div className="h-full rounded-2xl bg-white p-5">
              ...
              <p className="mt-5 text-sm leading-6 text-[#7A6F6A]">InsightCanvas summarizes the pattern once your chart is ready.</p>
            </div>
          </div>
          <div className="mt-6 flex flex-wrap gap-3">
            <Link to="/dashboard" className="pastel-button">Start Exploring</Link>
